var Address, Brand, Cart, Category, Checkout, Collection, Currency, Entry, Gateway, Language, Moltin, Order, Product, Shipping, Storage, Tax,
...
Moltin = (function() {
  ...
  Moltin.prototype.Authenticate = function(callback, error) {
    var isExpired, _e;
    isExpired = parseInt(this.Storage.get('mexpires')) > Date.now();
    if (this.options.publicId.length <= 0) {
      if (typeof error === 'function') {
        error('error', 'Public ID must be set', 401);
      }
    }
    if (this.Storage.get('mtoken') !== null && isExpired) {
      this.options.auth = {
  ...
  Moltin.prototype.Request = function(uri, method, data, callback, error) {
    ...
    this.Ajax({
      ...
      success: function(r, c, e) {
        ...
        pagination = null;
        if (typeof callback === 'function') {
          return callback(r.result, pagination);
        } else {
          return _data = r;
        }
      },
...
Address = (function() {
  ...
  Address.prototype.BaseUrl = function(customer) {
    return "customers/" + customer + "/addresses/";
  };

  Address.prototype.Get = function(customer, id, callback, error) {
    return this.m.Request("" + (this.BaseUrl()) + "/" + id, 'GET', null, callback, error);
  };

  Address.prototype.Find = function(customer, terms, callback, error) {
    return this.m.Request(this.BaseUrl, 'GET', terms, callback, error);
  };
  ...
  Address.prototype.Create = function(customer, data, callback, error) {
    return this.m.Request(this.BaseUrl, 'POST', data, callback, error);
  };
  ...
  Address.prototype.Fields = function(customer, id, callback, error) {
    ...
    if (customer > 0 && id <= 0) {
      uri = "" + this.BaseUrl + "/fields";
    } else if (customer > 0 && id > 0) {
      uri = "" + this.BaseUrl + "/" + id + "/fields";
    } else {
...
Cart = (function() {
  ...
  Cart.prototype.BaseUrl = function(identifier) {
    return "carts/" + identifier;
  };
  ...
  Cart.prototype.Contents = function(callback, error) {
    return this.m.Request(this.BasUrl(this.id), 'GET', null, callback, error);
  };
  ...
  Cart.prototype.Insert = function(id, qty, mods, callback, error) {
    ...
    return this.m.Request(this.BasUrl(this.id), 'POST', params, callback, error);
  };

  Cart.prototype.Update = function(id, data, callback, error) {
    return this.m.Request("" + (this.BasUrl(this.id)) + "/item/" + id, 'PUT', data, callback, error);
  };

  Cart.prototype.Delete = function(callback, error) {
    return this.m.Request(this.BasUrl(this.id), 'DELETE', null, callback, error);
  };

  Cart.prototype.Remove = function(id, callback, error) {
    return this.m.Request("" + (this.BaseUrl(this.id)) + "/item/" + id, 'DELETE', null, callback, error);
  };

  Cart.prototype.Item = function(id, callback, error) {
    return this.m.Request("" + (this.BaseUrl(this.id)) + "/item/" + id, 'GET', null, callback, error);
  };

  Cart.prototype.InCart = function(id, callback, error) {
    return this.m.Request("" + (this.BasUrl(this.id)) + "/has/" + id, 'GET', null, callback, error);
  };

  Cart.prototype.Checkout = function(callback, error) {
    return this.m.Request("" + (this.BasUrl(this.id)) + "/checkout", 'GET', null, callback, error);
  };

  Cart.prototype.Complete = function(data, callback, error) {
    return this.m.Request("" + (this.BasUrl(this.id)) + "/checkout", 'POST', data, callback, error);
  };
  ...
  Cart.prototype.Discount = function(code, callback, error) {
    ...
    if (code === null || code === false) {
      this.m.Request("" + (this.BasUrl(this.id)) + "/discount", 'DELETE', null, callback, error);
    }
    return this.m.Request("" + (this.BasUrl(this.id)) + "/discount", 'POST', params, callback.error);
  };
...
Checkout = (function() {
  ...
  Checkout.prototype.Payment = function(method, order, data, callback, error) {
    ...
    return this.m.Request(url, 'POST', data, callback, error);
  };
