...
describe('Build cart payloads', () => {
  it('should return a promotion item payload', () => {
    const payload = buildCartItemData('testcode', null, null, 'promotion_item')
  ...
  it('should return a cart item payload', () => {
    const payload = buildCartItemData('123', 4, true)
...
describe('Build cart item data', () => {
  it('should build cart item data with quantity', () => {
    const res = buildCartItemData('553f5378-1211-4efa-b575-b95247f7e4c6', '10',true, 'cart_item', { name: 'test' })
  ...
  it('should build promotion item data', () => {
    const res = buildCartItemData('promo123', 1, null, 'promotion_item', {
      name: 'test'
    })
