...
describe('Moltin addresses', () => {
  ...
  it('should return an array of customer addresses using a JWT', () => {
    ...
    return Moltin.Addresses.All({ customer: 'customer-1', token: 'testtoken' }).then((response) => {
      assert.lengthOf(response, 2);
    });
  });
  ...
  it('should return a single customer address', () => {
    ...
    return Moltin.Addresses.Get({ customer: 'customer-1', address: 'address-1' }).then((response) => {
  ...
  it('should return a single customer address using a JWT', () => {
    ...
    return Moltin.Addresses.Get({ customer: 'customer-1', address: 'address-1', token: 'testtoken' }).then((response) => {
      assert.propertyVal(response, 'id', 'address-1');
    });
  });
  ...
  it('should delete a customer address', () => {
    ...
    return Moltin.Addresses.Delete({ customer: 'customer-1', address: 'address-1' }).then((response) => {
  ...
  it('should delete a customer address using a JWT', () => {
    ...
    return Moltin.Addresses.Delete({ customer: 'customer-1', address: 'address-1', token: 'testtoken' }).then((response) => {
      assert.equal(response, '{}');
    });
  });
});
