...
describe('Moltin inventories', () => {
  ...
  it('should return a single product inventory', () => {
    ...
    return Moltin.Inventories.Get('inventory-1')
    .then((response) => {
  ...
  it('should return an array inventory transactions for specific product', () => {
    ...
    return Moltin.Inventories.GetTransactions('managed-product-1')
    .then((response) => {
      assert.lengthOf(response, 2);
    });
  });
  ...
  it('should increment stock', () => {
    ...
    return Moltin.Inventories.IncrementStock('managed-product-1', 100)
    .then((response) => {
  ...
  it('should decrement stock', () => {
    ...
    return Moltin.Inventories.DecrementStock('managed-product-1', 50)
    .then((response) => {
      assert.propertyVal(response, 'product_id', 'managed-product-1');
  ...
  it('should allocate stock', () => {
    ...
    return Moltin.Inventories.AllocateStock('managed-product-1', 10)
    .then((response) => {
      assert.propertyVal(response, 'product_id', 'managed-product-1');
  ...
  it('should deallocate stock', () => {
    ...
    return Moltin.Inventories.DeallocateStock('managed-product-1', 10)
    .then((response) => {
      assert.propertyVal(response, 'product_id', 'managed-product-1');
      assert.propertyVal(response, 'quantity', 10);
