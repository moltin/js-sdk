...
describe('Moltin files', () => {
  ...
  it('should create a product-main_image relationship', () => {
    ...
    return Moltin.Products.CreateRelationships(products[0].id, 'main-image', files[0].id)
    .then((response) => {
      assert.propertyVal(response, 'id', 'file-1');
    });
  });
  ...
  it('should delete a product-main_image relationship', () => {
    ...
    return Moltin.Products.DeleteRelationships(products[0].id, 'main-image', files[0].id)
    .then((response) => {
      assert.equal(response, '{}');
    });
  });
  ...
  it('should update the product-main_image relationship', () => {
    ...
    return Moltin.Products.UpdateRelationships(products[0].id, 'main-image', files[0].id)
    .then((response) => {
      assert.equal(response, '{}');
    });
  });
