...
export interface AccountMembershipsEndpoint
     ...
     */
    Get(accountId: string, accountMembershipId: string, token?: string): Promise<Resource<AccountMembership>>
     ...
     * @param token
     */
    Create(accountId: string, body: AccountMembershipCreateBody, token?: string): Promise<Resource<AccountMembership>>
     ...
     * @param token - The Bearer token to grant access to the API.
     */
    Delete(accountId: string, accountMembershipId: string, token?: string): Promise<{}>
